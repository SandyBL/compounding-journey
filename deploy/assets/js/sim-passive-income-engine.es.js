// GAME STATE
        ...
        const DEFAULT_LEADERBOARD = [
            { name: "Sofía Chen (Gurú FIRE)", months: 264, netWorth: 680000 },
            ...
            { name: "Sara y Alejandro", months: 384, netWorth: 390000 }
        ];
        ...
        function getLeaderboard() {
            const saved = localStorage.getItem('compounding_journey_leaderboard_es');
            if (saved) {
        ...
        function saveLeaderboard(data) {
            localStorage.setItem('compounding_journey_leaderboard_es', JSON.stringify(data));
        }
        ...
        function renderLeaderboardTable() {
            ...
            list.forEach((entry, idx) => {
                ...
                const timeStr = yrs > 0 ? `${yrs} Años (${entry.months}m)` : `${entry.months} Meses`;
            ...
            if (submitBox) {
                submitBox.innerHTML = `
                    <div class="text-center py-1 text-emerald-800 font-bold text-xs flex items-center justify-center gap-1.5">
                        ...
                        ¡Puntuación guardada en el Salón de la Fama!
                    </div>
                `;
            }
