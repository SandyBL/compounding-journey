---
title: "O que o nome do seu fundo esconde: categorias de investimento e regras
  regulatórias"
date: 2026-09-18
category: Investimentos
summary: O nome de um fundo não é mera propaganda; é um contrato legal. Descubra
  como os limites de ações, moedas e métricas de risco protegem seu patrimônio.
translation_key: what-your-funds-name-is-hiding-investment-mandates-and-regulatory-categories
...
> 💡 **A Base Fundamental:**
> O nome comercial de um fundo não é publicidade, é uma fronteira legal. Os órgãos reguladores exigem que os fundos mantenham uma fatia expressiva do patrimônio (geralmente acima de 67% a 80%) exatamente na classe de ativos descrita em seu título.
...
[ WAM Baixo ] ➔ Proteção contra oscilações na taxa de juros
[ WAL Baixo ] ➔ Proteção contra risco de calote dos emissores
...
> Pense no WAM como a velocidade com que um barco consegue ajustar suas velas quando o vento (a taxa de juros) muda amanhã. Pense no WAL como a distância no mapa até o barco chegar ao porto seguro (quando o emissor devolve o seu dinheiro investido).
...
| Categoria do Fundo | Exposição Máxima em Ações | Papel da Renda Fixa | Perfil de Risco |
| :--- | :--- | :--- | :--- |
| **Renda Fixa Pura** | **0% em Ações** | 100% Títulos / Caixa | Risco baixo, foco em estabilidade |
| **Multimercado Conservador** | **Até 30% em Ações** | Predominante na carteira | Risco moderado-baixo |
| **Multimercado Dinâmico** | **Entre 30% e 70%** | Equilíbrio de carteira | Risco moderado |
| **Fundos de Ações** | **Acima de 67% a 100%** | Apenas caixa operacional | Risco alto, foco em crescimento |
