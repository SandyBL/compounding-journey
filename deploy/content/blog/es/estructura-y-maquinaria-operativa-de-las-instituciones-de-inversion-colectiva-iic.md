---
title: Estructura y maquinaria operativa de las Instituciones de Inversión
  Colectiva (IIC)
date: 2026-09-14
category: Inversión
summary: ¿Te has preguntado qué ocurre en las entrañas de un fondo de inversión?
  Descubre cómo funcionan las gestoras, los depositarios y el cálculo del valor
  liquidativo.
...
Para garantizar la protección del inversor, la Comisión Nacional del Mercado de Valores (CNMV) impone una separación funcional absoluta entre tres figuras clave:
                 ...
                 └────────────┬───────────────┬────────────┘
                              │               │
       Prestación de servicio │               │ Vigilancia y Custodia
                              ▼               ▼
                 ┌─────────────────┐     ┌─────────────────┐
                 │ Gestora (SGIIC) │◄───►│   Depositario   │
                 └─────────────────┘     └─────────────────┘
                            Vigilancia Mutua
...
| Departamento | Responsabilidad Principal | Función Operativa Diaria |
| :--- | :--- | :--- |
| **Front Office** | Gestión y Análisis de Carteras | Toma de decisiones de inversión y ejecución en mercado |
...
Comprender la estructura de seguridad que protege tus ahorros es fundamental para invertir con total serenidad y criterio. Realiza nuestra evaluación de hábitos para revisar la eficiencia de tu cartera, analizar las comisiones de tus productos y construir un plan de inversión sólido a largo plazo.
