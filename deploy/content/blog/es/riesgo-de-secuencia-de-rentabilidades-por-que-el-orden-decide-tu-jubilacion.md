---
title: "Riesgo de secuencia: por qué el orden de las rentabilidades decide tu
 jubilación"
date: 2026-09-03
category: Inversión
summary: La misma rentabilidad media puede dejar a un jubilado tranquilo y a
 otro sin dinero. Lo que lo decide es el orden en que llegan los años buenos y
 malos, y eso es justo lo que ninguna media puede mostrarte.
translation_key: sequence-of-returns-risk
link_phrases: riesgo de secuencia, secuencia de rentabilidades, regla del 4 %, regla del 4%, tasa de retiro segura, simulación de Monte Carlo
...
| | Años malos primero | Años buenos primero |
|---|---|---|
| Inicio | 500.000 € | 500.000 € |
| Rentabilidad año 1 | −30 % | +50 % |
| Fin del año 1 | 332.500 € | 712.500 € |
| Rentabilidad año 2 | −10 % | −10 % |
| Fin del año 2 | 276.750 € | 618.750 € |
| Rentabilidad año 3 | +50 % | −30 % |
| **Fin del año 3** | **377.625 €** | **415.625 €** |
...
> El orden de las rentabilidades es irrelevante en una cartera que nadie toca, y decisivo en una de la que estás retirando. Vender participaciones en un mercado caído convierte una pérdida temporal en definitiva, porque esas participaciones ya no están cuando llega la recuperación.
...
Pasa tus propios números por el [simulador Monte Carlo FIRE](/es/simulators/monte-carlo-fire.html) y luego cambia una entrada cada vez para ver cuál le importa de verdad a la respuesta. Diez minutos ahí te enseñarán más sobre tu plan que otra rentabilidad media.

---

### ¿Listo para dominar tus hábitos financieros?
El orden de las rentabilidades no lo eliges tú, pero tu tasa de ahorro, tu colchón y tu reacción ante un año malo sí. Realiza nuestra evaluación de hábitos para ver dónde está fuerte tu plan y qué palanca conviene mover primero.
