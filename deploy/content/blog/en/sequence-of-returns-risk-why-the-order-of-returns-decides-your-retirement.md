...
date: 2026-09-03
category: Investing
summary: Two people can retire with the same money and earn the same average
 return, and still end up in very different places. What separates them is the
 order the good and bad years arrive in — and that's the one thing an average
 can never show you.
...
If the order matters, then a single projection is only telling you about one ordering out of an enormous number of possible ones. A [Monte Carlo simulation](/en/simulators/monte-carlo-fire.html) generates thousands of them instead.
...
So run your own numbers through the [Monte Carlo FIRE simulator](/en/simulators/monte-carlo-fire.html), then change one input at a time and watch which one the answer really cares about. Ten minutes there will teach you more about your own plan than another average return ever could.

---

### Ready to Master Your Money Habits?
The order of returns isn't something you control, but your savings rate, your cash buffer and your reaction to a bad year all are. Take our habit assessment to see where your plan is strong and which of those levers is worth pulling first.
