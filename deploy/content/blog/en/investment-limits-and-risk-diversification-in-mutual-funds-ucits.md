---
title: Investment Limits and Risk Diversification in Mutual Funds (UCITS)
date: 2026-09-15
category: Investing
summary: How do funds protect your money from massive market crashes? Discover
  the 5/10/40 rule, asset eligibility criteria, and index fund exemptions that
...
| Issuer / Asset Type | Maximum Investment Cap | Key Regulatory Condition |
| :--- | :--- | :--- |
| **Standard Corporation** | **5%** (Expandable to 10%) | Subject to the aggregate 40% rule |
| **Sovereign / Public Debt** | **Up to 35%** | Issued/guaranteed by EU states or top OECD nations |
| **Single Group Counterparty** | **20% Aggregate Cap** | Combines stocks + bonds + deposits + derivatives with 1 bank |
