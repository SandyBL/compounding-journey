...
In the US and UK financial markets, alternative investment funds (often regulated as Private Funds under SEC guidelines or AIFs under the FCA umbrella) allow managers to use unlimited leverage, short selling, and complex event-driven strategies.
...
Unlike standard retail mutual funds, hedge funds are built for institutional clients and accredited high-net-worth individuals. Because they take on complex risks, financial regulators enforce specific operating boundaries:

| Feature / Trait | Direct Hedge Funds | Fund of Hedge Funds (FoHF) |
| :--- | :--- | :--- |
| **Minimum Investment** | High entry barriers (often $100,000+ or accredited investor status) | Lower entry thresholds for retail or semi-professional investors |
| **Diversification Level** | Concentrated in specific manager strategies | Diversified across 10+ underlying hedge fund managers |
| **Concentration Limits** | Unrestricted position sizing | Single-fund cap (often maximum 10% per underlying fund) |
...
| **Leverage Limits** | High leverage allowed (often up to 5x net asset value) | Controlled aggregate portfolio leverage |

Because direct hedge funds use complex strategies, unaccredited or non-professional investors who gain entry are required to sign an explicit **Investor Disclosure Statement**. This document confirms that the investor fully understands the fund's low liquidity, lack of traditional diversification limits, and high risk of capital loss.
...
* **Beta ($\beta$):** The portion of performance driven by general market movements. If the S&P 500 rises 10% and your fund rises 10% purely because it holds large-cap stocks, you earned market Beta.
...
* **Value at Risk (VaR):** Estimates the maximum expected dollar loss over a given time horizon (e.g., 30 days) at a specific confidence level (e.g., 95% or 99%).
