...
- It assumes you **withdraw nothing** over the whole period. A withdrawal partway through breaks the effect being measured.`,
    ...
    pt: {
      ...
      intro: 'Informe o que você tem hoje, quanto consegue aportar cada mês e quantos anos vai dar ao dinheiro. A calculadora mostra quanto você pôs e quanto o tempo pôs.',
      labels: {
        initial: 'Capital inicial',
...
- Não inclui **comissões nem impostos**. Subtrair o custo do seu fundo da rentabilidade que você informa é a forma rápida de aproximá-los.
...
- It ignores **tax**, which in the withdrawal phase can be a meaningful share of real spending.`,
    ...
    pt: {
      ...
      intro: 'Diga-nos com que idade você quer ter a opção de deixar de trabalhar e com que renda mensal. Devolvemos o número e quanto custaria por mês chegar até ele.',
      labels: {
...
- It is not trying to tell you **not** to buy. Plenty of purchases still make sense expressed in hours, and knowing which is exactly the point.`,
    ...
    pt: {
      ...
      intro: 'O dinheiro é tempo trocado. Informe o seu salário, as suas horas reais de trabalho e o preço de algo que você esteja considerando, e veja o que custa na única moeda que não se recupera.',
      labels: {
